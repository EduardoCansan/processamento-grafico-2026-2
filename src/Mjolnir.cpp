...
int loadSimpleOBJ(string filePATH, int &nVertices)
{
    ...
    std::cout << "Buffer de geometria gerado com " << NVertices << " vértices" << std::endl;
...
void inicializaObjetos()
{
    ...
    carregaTextura("../assets/Modelos3D/thor_hammer.jpg");
    Vao = loadSimpleOBJ("../assets/Modelos3D/thor_hammer.obj", NVertices);
}

void inicializaShaders()
{
    // 1. Lê o código dos arquivos externos
    std::string vertexCode = leShaderDoArquivo("../assets/shaders/5/3/vertex_shader.glsl");
    std::string fragmentCode = leShaderDoArquivo("../assets/shaders/5/3/fragment_shader.glsl");
